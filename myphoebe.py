...
class Myphoebe(object):
  ...
  def __init__(self, debug=True):
    ...
    self.b.set_value(qualifier='ld_coeffs', dataset='lcB', component='secondary', value=[0.15,0.31])
    self.b.set_value(qualifier='ld_coeffs', dataset='lcR', component='secondary', value=[0.31,0.26]) 
    self.b.set_value(qualifier='ld_coeffs', dataset='rv1', component='secondary', value=[0.35,0.24])
    self.b.set_value(qualifier='ld_coeffs', dataset='rv2', component='secondary', value=[0.35,0.24]) 
  ...
  def model(self, theta):
    ...
    '''
    T2,R1,R2,I,SA,SB,M1,M2,e,omega,gamma,T0 = theta
...
#    T1    = 27079.6426382378776907   # K
    ...
    theta = T2,R1,R2,I,SA,SB,M1,M2,e,omega,gamma,T0
    return theta
...
def p0_func(theta, nwalkers=None, delta=1e-7):
  '''
